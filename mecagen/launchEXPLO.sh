...
export LD_LIBRARY_PATH=$PWD/consumers/lib/$1:$PWD/producers/lib/$1:$PWD/model/lib/$1:$LD_LIBRARY_PATH
...
$DIR./explo/bin/mecagenEXPLO "$@"
# gdb --args $DIR/explo/bin/mecagenEXPLO "$@"
